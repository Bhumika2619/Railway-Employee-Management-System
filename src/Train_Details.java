...
public class Train_Details extends javax.swing.JFrame {
    ...
    public Train_Details() {
        initComponents();
        setDefaultCloseOperation(Train_Details.DISPOSE_ON_CLOSE);
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "TRAIN ID", "TRAIN NAME", "SOURCE", "DESTINATION", "SCHEDULE"
            }
        ));
    ...
    private void fetchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fetchActionPerformed
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                model.addRow(new Object[] {trainid,trainname,source,destination,schedule});
